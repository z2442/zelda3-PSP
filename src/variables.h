...
#define force_move_any_direction (*(unaligned_uint16*)(g_ram+0x49))
...
#define tiledetect_which_y_pos ((unaligned_uint16*)(g_ram+0x51))
...
#define tiledetect_var2 (*(unaligned_uint16*)(g_ram+0x5F))
...
#define dungmap_idx (*(unaligned_uint16*)(g_ram+0x211))
#define dungmap_var4 (*(unaligned_uint16*)(g_ram+0x213))
#define dungmap_var3 (*(unaligned_uint16*)(g_ram+0x215))
#define dungmap_var5 (*(unaligned_uint16*)(g_ram+0x217))
#define word_7E0219 (*(unaligned_uint16*)(g_ram+0x219))
#define word_7E021D (*(unaligned_uint16*)(g_ram+0x21D))
#define word_7E021F (*(unaligned_uint16*)(g_ram+0x21F))
#define word_7E0221 (*(unaligned_uint16*)(g_ram+0x221))
...
#define word_7E02CD (*(unaligned_uint16*)(g_ram+0x2CD))
...
#define tiledetect_chest (*(unaligned_uint16*)(g_ram+0x2E5))
...
#define swimcoll_var5 ((unaligned_uint16*)(g_ram+0x32B))
#define swimcoll_var1 ((unaligned_uint16*)(g_ram+0x32F))
...
#define tiledetect_deepwater (*(unaligned_uint16*)(g_ram+0x341))
#define tiledetect_normal_tiles (*(unaligned_uint16*)(g_ram+0x343))
...
#define tiledetect_thick_grass (*(unaligned_uint16*)(g_ram+0x357))
#define tiledetect_shallow_water (*(unaligned_uint16*)(g_ram+0x359))
#define tiledetect_destruction_aftermath (*(unaligned_uint16*)(g_ram+0x35B))
#define oam_priority_value_2 (*(unaligned_uint16*)(g_ram+0x35D))
...
#define boomerang_temp_y (*(unaligned_uint16*)(g_ram+0x399))
#define boomerang_temp_x (*(unaligned_uint16*)(g_ram+0x39B))
...
#define tiledetect_var4 (*(unaligned_uint16*)(g_ram+0x3F1))
#define link_on_conveyor_belt (*(uint8*)(g_ram+0x3F3))
#define dung_unk6 (*(uint8*)(g_ram+0x3F4))
#define link_timer_tempbunny (*(unaligned_uint16*)(g_ram+0x3F5))
...
#define word_7E0405 (*(unaligned_uint16*)(g_ram+0x405))
...
#define dungmap_var6 (*(unaligned_uint16*)(g_ram+0xCF5))
...
#define dialogue_msg_read_pos (*(unaligned_uint16*)(g_ram+0x1CD9))
#define dialogue_text_color (*(uint8*)(g_ram+0x1CDC))
#define dialogue_msg_src_offs (*(unaligned_uint16*)(g_ram+0x1CDD))
...
#define poly_fromlut_ptr2 (*(unaligned_uint16*)(g_ram+0x1F41))
#define poly_fromlut_ptr4 (*(unaligned_uint16*)(g_ram+0x1F43))
...
#define poly_raster_color0 (*(unaligned_uint16*)(g_ram+0x1FB5))
#define poly_raster_color1 (*(unaligned_uint16*)(g_ram+0x1FB7))
#define poly_raster_dst_ptr (*(unaligned_uint16*)(g_ram+0x1FB9))
...
#define poly_x0_frac (*(unaligned_uint16*)(g_ram+0x1FE5))
#define poly_x0_step (*(unaligned_uint16*)(g_ram+0x1FE7))
...
#define palette_filter_countdown (*(unaligned_uint16*)(g_ram+0xC007))
#define darkening_or_lightening_screen (*(unaligned_uint16*)(g_ram+0xC009))
#define mosaic_target_level (*(uint8*)(g_ram+0xC00B))
#define mosaic_target_level_PADDING (*(uint8*)(g_ram+0xC00C))
#define bg_tile_animation_countdown (*(unaligned_uint16*)(g_ram+0xC00D))
#define word_7EC00F (*(unaligned_uint16*)(g_ram+0xC00F))
#define mosaic_level (*(uint8*)(g_ram+0xC011))
#define word_7EC013 (*(unaligned_uint16*)(g_ram+0xC013))
#define word_7EC015 (*(unaligned_uint16*)(g_ram+0xC015))
#define overworld_fixed_color_plusminus (*(uint8*)(g_ram+0xC017))
#define agahnim_pal_setting ((unaligned_uint16*)(g_ram+0xC019))
...
#define overworld_screen_index_prev (*(unaligned_uint16*)(g_ram+0xC213))
#define map16_load_src_off_prev (*(unaligned_uint16*)(g_ram+0xC215))
#define map16_load_var2_prev (*(unaligned_uint16*)(g_ram+0xC217))
#define map16_load_dst_off_prev (*(unaligned_uint16*)(g_ram+0xC219))
#define overworld_screen_transition_prev (*(uint8*)(g_ram+0xC21B))
#define overworld_screen_trans_dir_bits_prev (*(unaligned_uint16*)(g_ram+0xC21D))
#define overworld_screen_trans_dir_bits2_prev (*(unaligned_uint16*)(g_ram+0xC21F))
#define mapbak_bg1_x_offset (*(unaligned_uint16*)(g_ram+0xC221))
#define mapbak_bg1_y_offset (*(unaligned_uint16*)(g_ram+0xC223))
#define mapbak_CGWSEL (*(unaligned_uint16*)(g_ram+0xC225))
...
#define saved_tagalong_y (*(unaligned_uint16*)(g_ram+0xF3CD))
#define saved_tagalong_x (*(unaligned_uint16*)(g_ram+0xF3CF))
...
#define deaths_per_palace ((unaligned_uint16*)(g_ram+0xF3E7))
#define death_save_counter (*(unaligned_uint16*)(g_ram+0xF403))
#define death_var2 (*(unaligned_uint16*)(g_ram+0xF405))
...
#define attract_var7 (*(unaligned_uint16*)(g_ram+0x2D))
...
#define quake_var1 (*(unaligned_uint16*)(g_ram+0x1580B))
#define quake_var2 (*(unaligned_uint16*)(g_ram+0x1580D))
...
#define bombos_y_coord ((unaligned_uint16*)(g_ram+0x15955))
#define bombos_x_coord ((unaligned_uint16*)(g_ram+0x159D5))
...
#endif
#define dung_line_ptrs_row0 (*(unaligned_uint16*)(g_ram+0xbf))
